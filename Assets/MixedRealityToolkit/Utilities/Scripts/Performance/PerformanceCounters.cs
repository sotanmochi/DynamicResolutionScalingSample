...
public class PerformanceCounters : ImprovedSingletonBehavior<PerformanceCounters>
{
    ...
    private Camera hmdCam;

    private GpuTimingCamera gpuCam;
    ...
    protected override void InitializeInternal()
    {
        ...
        gpuCam = hmdCam.GetComponent<GpuTimingCamera>();
        if (gpuCam == null || gpuCam.TimingTag.CompareTo("Frame") != 0)
        {
            gpuCam = hmdCam.gameObject.AddComponent<GpuTimingCamera>();
        }
    ...
    protected void Update()
    {
        ...
        if(profileGpuTime)
        {
            LastFrameGpuTime = gpuCam.LastFrameTime;
        }
